DROP TABLE ACHETE_CASE;
DROP TABLE UTILISE_PION;
DROP TABLE AMIS;
DROP TABLE OPPOSITION;
DROP TABLE TROPHEE_JOUEUR;
DROP TABLE DIFFICULTE_TROPHEE;
...
dateInscr DATE NOT NULL DEFAULT SYSDATE ,
lastCo DATE NOT NULL DEFAULT SYSDATE,
